...
export interface TeaTaxonomyReference { familyId: string; subfamilyId?: string; styleId?: string; }
export interface TeaRepository { create(tea: TeaWriteInput, taxonomy: TeaTaxonomyReference): void; getById(id: string): Tea | undefined; list(): Tea[]; update(tea: TeaWriteInput, taxonomy: TeaTaxonomyReference): Tea | undefined; }
